...
class Bialsoft_Easyvariantscreator_Adminhtml_Catalog_ProductController extends Mage_Adminhtml_Catalog_ProductController {
...
//print_r($skus);
            ...
            foreach ($combinations as $combination) {
                ...
                if (!$__product) {
                    ...
                    $this->_getSession()->addSuccess("Subproduct added: " . $product->getId());
                } else {
                    $newids[$__product->getId()] = 1;
                    $this->_getSession()->addSuccess("Subproduct updated: " . $__product->getId());
                }
            }
